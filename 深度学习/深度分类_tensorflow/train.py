...
tf.flags.DEFINE_string("bingyin_data_file", "bingyin.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("zhenduan_data_file", "zhenduan.txt", "Data source for the negative data.")
tf.flags.DEFINE_string("zhiliao_data_file", "zhiliao.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("zhengzhuang_data_file", "zhengzhuang.txt", "Data source for the negative data.")
...
# Load data
print("Loading data...")
x_text, y = data_helpers.load_positive_negative_data_files(FLAGS.bingyin_data_file, FLAGS.zhenduan_data_file, FLAGS.zhiliao_data_file, FLAGS.zhengzhuang_data_file)
